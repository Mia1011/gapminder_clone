...
fig = px.scatter(plotting_df, x="gdp_per_capita", y="life_expectancy", 
                 ...
                 size_max=100, range_x=[500, 100000], range_y=[20, 100], log_x=True,
                 title="Gapminder Clone 1800-2023")

# continents = ['All', 'Asia', 'Africa', 'Europe', 'Americas']

fig.write_html("gapminder_clone.html", auto_open=False)
